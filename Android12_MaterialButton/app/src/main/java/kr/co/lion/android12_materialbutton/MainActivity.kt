        ...
        activityMainBinding.apply {
            ...
            toggleGroup1.addOnButtonCheckedListener { group, checkedId, isChecked ->
                ...
                when(checkedId){
                    R.id.toggleButton1 -> {
                        if(isChecked){
                            textView.text = "토글 버튼 1이 체크 되었습니다."
                        } else {
                    ...
                    R.id.toggleButton2-> {
                        if(isChecked){
                            textView.text = "토글 버튼 2가 체크 되었습니다."
                        } else {
                            textView.text = "토글 버튼 2가 체크 해제 되었습니다"
                        }
                    }
                    R.id.toggleButton3 -> {
                        if(isChecked){
                            textView.text = "토글 버튼 3이 체크 되었습니다."
                        } else {
                ...
                /*when(checkedId){
                    R.id.toggleButton4 -> {
                        if(isChecked){
                            ...
                            textView.text = "토글 버튼 4가 체크 해제 되었습니다"
                        }
                    }
                    R.id.toggleButton5-> {
                        if(isChecked){
                            ...
                            textView.text = "토글 버튼 5가 체크 해제 되었습니다"
                        }
                    }
                    R.id.toggleButton6 -> {
                        if(isChecked){
                            ...
                            textView.text = "토글 버튼 6이 체크 해제 되었습니다"
                        }
                    }
                }*/
